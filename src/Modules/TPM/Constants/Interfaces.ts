export enum TreatmentCertificationCode {
    TREATMENT_CERTIFICATE = "TC",
}
export enum DocumentInfo {
    ...
    TREATMENT_REG_AMENDMENT_DOC_TYPE_CODE = "C11",
    TREATMENT_REG_RENEWAL_DOC_TYPE_CODE = "C13",
    ...
    // ePhyto Certificate 
    EPHYTO_EC_DOCUMENT_TYPE_CODE="EP1",
...
export enum TreatmentTypesRegistrationStatus {
    DRAFT = 1,
    ACTIVE = 2,
    SUSPEND = 3,
    CANCELLED = 4,
...
export enum TreatmentProviderRegistrationStatus {
    DRAFT = 1,
    ACTIVE = 2,
    SUSPEND = 3,
    TREATMENT_ONBOARDING = 4,
...
export enum TreatmentProviderRegistrationAmendmentStatus {
    SAVED = 1,
    SUBMITTED = 2,
    PAYMENT_RECEIVED = 3,
    CANCELLED = 4,
...
export enum Action {
    ...
    GenerateNonComplianceNotice="GenerateNonComplianceNotice"
}
...
export enum ElectronicPhytosanitoryCertificateStatus {
    AWAITING_SHIPMENT =1,
    VALIDATION_ERROR =2,
    VALIDATED=3,
    INVALID_EPHYTO=4,
