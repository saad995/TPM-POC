import { SET_IS_LOADING } from "../../../TreatmentCertificate/InitiateTreatmentRequest/InitiateTreatmentRequestActionTypes";
import { EXPORT_TP_ASSIGN, GET_TREATMENT_REQUEST_DATA, POST_UPDATE_CONTAINER_NUMBER, REJECT_TREATMENT_REQUEST, RE_ASSIGN_TREATMENT_PROVIDER, SET_IS_LOADING_TO_FALSE, SET_IS_RESCIND_VALUE, SUBMIT_TREATMENT_CERTIFICATE, UPDATE_SINGLE_ISSUE_TREATMENT_REQUEST_DATA } from "./ActionTypes";
...
// * reducer function
const IndependentViewReducer = (state: IDefaultInfoState = defaultState, action: any): IDefaultInfoState => {
...
export default IndependentViewReducer;
