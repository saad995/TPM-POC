...
import { IPrintRequestData, IPrintResponseData } from "./ExportPdfTpmInterfaces";
import DownloadService from "./ExportPdfServiceTpm";

interface IBlobType {
  data: BlobPart;
}

const ExportPdfTpm = (props: any) => {
...
export default React.memo(ExportPdfTpm);