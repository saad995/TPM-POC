...
import * as ActionType from "./AmendmentTreatmentTypeActionTypes";
import {
...
} from "./AmendmentTreatmentTypeActionTypes";
...
export interface ISaveTreatmentTypeLicenseGridDataType {
    type: typeof ActionType.SAVE_TREATMENT_LICENSE_GRID_DATA;
    payload: any[];
}

export interface IDeleteTreatmentTypeLicenseGridDataType {
    type: typeof ActionType.DELETE_TREATMENT_LICENSE_GRID_DATA;
    payload: any;
}
export interface ISaveTreatmentTypeLicenseGridClearDataType {
    type: typeof ActionType.SAVE_TREATMENT_LICENSE_GRID_DATA_CLEAR;
}
...
export interface ISubmitRenewalTreatmentTypeData {
    type: typeof ActionType.SUBMIT_RENEWAL_TREATMENT_TYPE_DATA;
    payload:any;
}

export interface ISubmitRenewalTreatmentType {
    treatmentProviderId:string;
    treatmentTypeProviderRegistrationId:string;
    purpose:string;
    treatmentTypeInformation:ITreatmentTypeInformation;
    treatmentTypeAttachments:ITreatmentTypeAttachments[];
    treatmentSubTypes:ITreatmentSubTypes
...
export enum TreatmentPurpose {
 ...
 interface ITreatmentTypeInformation {
    treatmentTypeId:number,
    isSubType:boolean;
    ...
    packHouse:boolean;
    validUpto:string;
    treatmentOperatorInfo:string;
    isSaveCompleted:boolean;
}

interface ITreatmentTypeAttachments {
    documentTitle:string;
    fieldS:string;
    attachedDocumentTypeCode:string;
}

interface ITreatmentSubTypes {
    subTypeDocumentTypeCode:string;
    treatmentSubTypeId:number;
    treatmentSubTypeAttachments:ITreatmentTypeAttachments[]
}
export type ICreateEditTPRegistrationFormReducerTypes =
    ...
    | ISaveTreatmentTypeLicenseGridDataType
    | ISaveTreatmentTypeLicenseGridClearDataType
    | IDeleteTreatmentTypeLicenseGridDataType
    | ISubmitRenewalTreatmentTypeData;