...
import { faFileUpload, faPencilAlt, faUpload, faSyncAlt, faPrint, faIcons, faEye, faPenAlt } from "@fortawesome/free-solid-svg-icons";
...
const GridActionCell = (props: any) => {
    const { rowData, agencyId, IStatusInterface, isDetailAction, handleDetailItemView, URL } = props;
   
    const { dataItem } = rowData;
    const { id, requestDocumentTypeCode, currentRecordEncryptedId, currentRecordId, parentDocumentTypeCode, statusId, initDocumentTypeCode, agencyBusinessRegistrationId} = dataItem;
...
//         return history.push(URL.ViewItem, data);
    ...
    switch (statusId) {
        ...
        case IStatusInterface.TREATMENT_ONBOARDING:
            {
            Actions = (
